...
const STRINGS = {
  en: {
    ...
    scatterCaption: 'Every character — <b>usage rate</b> (how often they are played) vs <b>overall win rate</b>. The win-rate axis spans barely 1.5 points: the cast is tightly balanced, so quadrants matter more than exact position.',
  ...
  zh: {
    ...
    labelSubs: '副角推荐',
    labelScatter: '使用率 × 胜率',
    scatterCaption: '全角色 — <b>使用率</b>（被使用的频率）对比<b>总体胜率</b>。胜率轴的跨度仅约 1.5 个百分点：版本高度平衡，因此所处象限比精确位置更重要。',
