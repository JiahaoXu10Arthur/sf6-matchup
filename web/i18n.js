...
const STRINGS = {
  en: {
    ...
    scoutBmHint: 'Drag this button to your bookmarks bar, then click it while logged in at the Capcom Buckler site. It copies your ranked log as JSON.',
  ...
  zh: {
    ...
    scoutBmTitle: '导入战斗记录',
    scoutBmHint: '把这个按钮拖到书签栏，然后在已登录的 Capcom Buckler 网站上点击它，它会把你的排位记录复制为 JSON。',
