...
const STRINGS = {
  en: {
    ...
    labelThreats: 'THREAT MAP',
    threatAxisUsage: 'How often you face them (usage %)',
    threatAxisWin: 'Your win rate %',
    threatFaced: 'faced',
    quadComfort: 'Common · you win',
    quadFree: 'Rare · you win',
    quadPriority: 'PRIORITY · common & losing',
    quadMinor: 'Rare · you lose',
    threatCaption: 'Where {char} should practice — opponents in the lower-right (common, and you lose) are the priority. Dot size = data confidence.',
    close: 'Close',
    ccWin: 'Win rate',
    ccUsage: 'Usage',
    ccStrong: 'Strong vs',
  ...
  zh: {
    ...
    quadComfort: '常见 · 你赢',
    quadFree: '少见 · 你赢',
    quadPriority: '重点 · 常见且劣势',
    quadMinor: '少见 · 你输',
    threatCaption: '{char} 该练哪些对位 —— 右下角（常见且你劣势）是重点。点越大数据越可信。',
    close: '关闭',
    ccWin: '胜率',
    ccUsage: '使用率',
    ccStrong: '擅长对位',
