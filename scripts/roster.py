...
# matchup value, so weight it more. Master (entry tier, lowest skill, noisiest)
# is excluded by default (weight 0); all are user-adjustable (continuous) in the
# web app, so Master can be dialed back in.
TIER_WEIGHTS = {36: 0, 40: 1, 41: 2, 42: 3}
