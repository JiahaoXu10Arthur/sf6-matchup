...
const [csvPath, charName, profile, weightsJson, usageJson] = process.argv.slice(2);
...
const usage = usageJson ? JSON.parse(usageJson) : undefined;
...
const subs = {};
const st = s.subTable(idx, charName, mw, exclude, s.DEFAULT_TIER_WEIGHTS, oppWeights, usage);
